...
```{r, echo=TRUE, fig.cap= "Cuenta de insectos según tipo de insecticida"}
...
```{r, echo=FALSE, fig.cap= "Ancho de sépalo según especie del género Iris"}
...
```{r, echo=FALSE, fig.cap= "Histograma de los resiudales del modelo ANOVA"}
hist(Residuales)
```
